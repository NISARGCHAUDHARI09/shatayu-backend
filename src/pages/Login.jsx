            ...
            <Flex direction={{ base: 'column', lg: 'row' }} minH="600px">
              ...
              >
                ...
                <VStack spacing={6} textAlign="center" position="relative" zIndex={1}>
                  {/* Doctor illustration placeholder - we'll use emoji for now */}
                  <Box 
                    fontSize="120px" 
                    lineHeight="1"
                ...
                <VStack spacing={8} w="full" maxW="400px" mx="auto">
                  ...
                  <HStack spacing={3} alignSelf="flex-start">
                    ...
                    <Text fontSize="xl" fontWeight="600" color="gray.700">
                      <Text as="span" color="teal.400">LOGO</Text> Hospital
                    </Text>
                  </HStack>
                  ...
                  <form onSubmit={handleSubmit} style={{ width: '100%' }}>
                    <VStack spacing={6} align="stretch">
                        ...
                        <InputGroup size="lg">
                          <Input
                            ...
                            _focus={{
                              ...
                              boxShadow: error ? '0 0 0 1px #F56565' : '0 0 0 1px #4FD1C7',
                              bg: 'white'
                            }}
                            fontSize="sm"
                          />
                      ...
                      <Button
                        ...
                        bg="linear-gradient(135deg, #4FD1C7 0%, #3182CE 100%)"
                        color="white"
                        borderRadius="lg"
                        _hover={{ 
                          bg: "linear-gradient(135deg, #38B2AC 0%, #2B6CB0 100%)",
                          transform: "translateY(-1px)",
                          boxShadow: "0 4px 12px rgba79, 209, 197, 0.4)"
                        }}
